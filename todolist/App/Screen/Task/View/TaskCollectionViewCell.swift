    ...
    @objc func addTapped(_ sender: Any) {
        ...
        alertController.addAction(UIAlertAction(title: "Add", style: .default, handler: { (_) in
            ...
            readTaskApi(boardID: self.boardID!, onCompleted: { (error, tasks) in
                if let error = error {
                    self.parentVC?.TaskVM.getonTaskerror(error: error)
...
extension TaskCollectionViewCell: UITableViewDataSource, UITableViewDelegate {
...
extension TaskCollectionViewCell: UITableViewDragDelegate {
...
extension TaskCollectionViewCell: UITableViewDropDelegate {
